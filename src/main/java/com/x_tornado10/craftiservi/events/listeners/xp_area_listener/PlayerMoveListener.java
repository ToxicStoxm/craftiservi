package com.x_tornado10.craftiservi.events.listeners.xp_area_listener;
...
public class PlayerMoveListener implements Listener {
    ...
    public void onDeath(PlayerDeathEvent e) {
        ...
        if (playersinsavearea.containsKey(pid)) {
            ...
            logger.info(p.getName() + " died within an XpSaveZone! At: " + df.format(p.getLocation().getX()) + "|" + df.format(p.getLocation().getY()) + "|" + df.format(p.getLocation().getZ()) + " in world '" + (world != null ? world.getName() : "name not found") + "'");
